...
public class Main {
    ...
    public static void main(String[] args) {
        Hamburger myBurger = new Hamburger("Grub", "Beef", "Potato Roll", 5.00);
        myBurger.addHamburgerTopping1("Lettuce", 0.30).addHamburgerTopping2("Onion", 0.40).addHamburgerTopping3("Tomato", 0.50).addHamburgerTopping4("Mushroom", 0.75);
        System.out.println(String.format("Total price of burger: $%.2f \n", myBurger.itemizeHamburger()));
